document.addEventListener('DOMContentLoaded', () => {
    ...
    if (cursorDot && cursorRing) {
        ...
        // Rilevamento elementi per l'effetto Hover
        const interactiveElements = document.querySelectorAll('a, button, .btn, .slider-nav, .slider-dot, .feature-card, .flip-card, .step-icon, .play-button, .clickable, .project-wrapper, #flipCoinWrapper');
